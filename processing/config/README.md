Directory to define configuration that will be used. Specifically, here you should create a txt file (passed as a string) where the pseudorapidity and momentum bins are defined.
