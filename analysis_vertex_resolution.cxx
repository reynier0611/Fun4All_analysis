...
int main(int argc, char ** argv) {
	...
	// -------------------------
	// Binning
	float eta_bin[] = {0.0,0.5,1.0,1.5,2.0,2.5,3.0,3.5};
	...
	for(int et = 0 ; et < size_eta_bin-1 ; et++){
		h1_dvl_v_p_et_bins[et] = new TH1F(Form("h1_dvl_v_p_et_bins_%i",et),";p [GeV/c];dca_{z} [cm]",size_mom_bin-1,mom_bin);	prettyTH1F( h1_dvl_v_p_et_bins[et] , 51+7*et , 20 , 0. , 10. );
		h1_dvt_v_p_et_bins[et] = new TH1F(Form("h1_dvt_v_p_et_bins_%i",et),";p [GeV/c];dca_{T} [cm]",size_mom_bin-1,mom_bin);	prettyTH1F( h1_dvt_v_p_et_bins[et] , 51+7*et , 20 , 0. , 1.  );
	}
	...
	for(int p = 0 ; p < size_mom_bin-1 ; p++){
		h1_dvl_v_et_p_bins[p] = new TH1F(Form("h1_dvl_v_et_p_bins_%i",p),";#eta;dca_{z} [cm]",size_eta_bin-1,eta_bin);	prettyTH1F( h1_dvl_v_et_p_bins[p] , 51+3*p , 20 , 0. , 10. );
		h1_dvt_v_et_p_bins[p] = new TH1F(Form("h1_dvt_v_et_p_bins_%i",p),";#eta;dca_{T} [cm]",size_eta_bin-1,eta_bin);	prettyTH1F( h1_dvt_v_et_p_bins[p] , 51+3*p , 20 , 0. , 1.  );
	}
	// -------------------------------------------------------------
	...
	h1_dvl_v_p_et_bins[0] -> SetMinimum(2);	h1_dvl_v_p_et_bins[0] -> GetYaxis() -> SetMoreLogLabels();	h1_dvl_v_p_et_bins[0]->GetYaxis()->SetTitleOffset(2.3);
	h1_dvt_v_p_et_bins[0] -> SetMinimum(2);	h1_dvt_v_p_et_bins[0] -> GetYaxis() -> SetMoreLogLabels();      h1_dvt_v_p_et_bins[0]->GetYaxis()->SetTitleOffset(2.3);
	h1_dvl_v_et_p_bins[0] -> SetMinimum(2);	h1_dvl_v_et_p_bins[0] -> GetYaxis() -> SetMoreLogLabels();      h1_dvl_v_et_p_bins[0]->GetYaxis()->SetTitleOffset(2.3);
	h1_dvt_v_et_p_bins[0] -> SetMinimum(2);	h1_dvt_v_et_p_bins[0] -> GetYaxis() -> SetMoreLogLabels();      h1_dvt_v_et_p_bins[0]->GetYaxis()->SetTitleOffset(2.3);

	h1_dvl_v_p_et_bins[0] -> SetMaximum(20000);
	h1_dvt_v_p_et_bins[0] -> SetMaximum(20000);
	h1_dvl_v_et_p_bins[0] -> SetMaximum(20000);
	h1_dvt_v_et_p_bins[0] -> SetMaximum(20000);
	...
	c1 -> cd(2);
	leg1 -> Draw("same");
	TLegend * leg2 = new TLegend(0.20,0.75,0.90,0.95);
	leg2 -> SetLineColor(0);
	leg2 -> SetNColumns(3);
