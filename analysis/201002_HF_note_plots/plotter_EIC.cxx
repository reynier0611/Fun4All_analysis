...
int main(int argc, char ** argv) {
	...
	int vtx_color[] = {51,92,210};
	int vtx_marker[] = {29,23,22};
	...
	TLegend * leg1 = new TLegend(0.20,0.4,0.75,0.95);
        leg1 -> SetLineColor(0);
        //leg1 -> AddEntry((TObject*)0, "Beast (3.0 T)", "B = 3.0 T");
	leg1 -> AddEntry((TObject*)0, "3.0 T solenoid","");
	...
	//leg1 -> AddEntry( (TObject*)0, "sPHENIX(1.4 T)", "B = 1.4 T");
	leg1 -> AddEntry( (TObject*)0, "1.4 T solenoid","");
	...
	// ------------
	TLegend * leg2 = new TLegend(0.55,0.5,0.95,0.95);
        leg2 -> SetLineColor(0);
	//leg2 -> AddEntry((TObject*)0, "Beast (3.0 T)", "B = 3.0 T");
	leg2 -> AddEntry((TObject*)0, "3.0 T solenoid", "");
	...
	*/
	...
	c1 -> Print("results_plotter_EIC.pdf");
...
TGraphErrors * graph_from_histo( TH1F * h1 , int color , int marker , float min , float max ){
	...
	if(marker==29) g_l1->SetMarkerSize(1.9);
	g_l1->SetLineWidth(2);
